...
# Train Test Split
oversample = SMOTE()
Norm_electrode_data, labels = oversample.fit_resample(Norm_electrode_data, labels)
...
history = model.fit(train_data_gen, validation_data=test_data_gen, steps_per_epoch=26, epochs=2)  # add callback for early stopping
